...
class PAM_Module(Module):
    ...
    def __init__(self, in_dim):
        ...
        # self.act_extend = nn.RReLU(2 * self.chanel_in, lower=0.125, upper=0.3333333333333333)
        # self.act_squz = nn.RReLU(self.chanel_in, lower=0.125, upper=0.3333333333333333)
        # self.act = nn.RReLU(self.chanel_in, lower=0.125, upper=0.3333333333333333)
